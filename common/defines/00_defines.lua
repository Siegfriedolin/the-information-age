...
NDiplomacy = {
	...
	VOLUNTEERS_PER_TARGET_PROVINCE = 0.06,			-- Each province owned by the target country contributes this amount of volunteers to the limit.
	VOLUNTEERS_PER_COUNTRY_ARMY = 0.09,				-- Each army unit owned by the source country contributes this amount of volunteers to the limit.
	VOLUNTEERS_RETURN_EQUIPMENT = 1.0,				-- Returning volunteers keep this much equipment
	...
	TENSION_PUPPET = 3,								-- Amount of tension generated by puppeting (per state)
	...
	TENSION_TIME_SCALE_START_DATE = "2018.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
	...
	TENSION_CAPITULATE = 0.65,						-- Scale of the amount of tension created by a countries capitulation.
	...
	IDEOLOGY_JOIN_FACTION_MIN_LEVEL = 0.15,			-- ideology limit required to join faction
...
NCountry = {
	...
	NUCLEAR_BOMB_DROP_WAR_SUPPORT_EFFECT_MAX_INFRA = 0.3, -- Reduce enemy national war support on nuking a province, the value scales with infrastructure up to this number
...
NMilitary = {
	...
	CORPS_COMMANDER_DIVISIONS_CAP = 48,			-- how many divisions a corps commander is limited to. 0 = inf, < 0 = blocked
	...
	FIELD_MARSHAL_ARMIES_CAP = 20,				-- how many armies a field marshall is limited to. 0 = inf, < 0 = blocked
